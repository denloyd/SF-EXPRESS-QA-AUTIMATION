...
String filePath = 'C:\\Users\\denlo\\OneDrive\\Desktop\\OJT Tasks\\OJT related tasks\\OJT MANUAL TESTING\\SF CHI\\SF-EXP-SUWP-00004.xlsx'
...
for (int i = 0; i < excelDates.size(); i++) {
	...
	WebUI.comment("Expected DATE (Excel): ${excelDates[i]} | Actual DATE (UI): ${actualDate}")

	WebUI.verifyMatch(actualDate, excelDates[i], false)
}
